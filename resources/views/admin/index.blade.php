    ...
    <div class="row">
        <div class="col">
            <div class="list-group">
                ...
                <a href="{{route('admin.team.qualifiers.app.list')}}" class="list-group-item list-group-item-action">複賽隊伍APP檔案下載列表</a>
                <a href="{{route('admin.team.qualifiers.proposal.list')}}" class="list-group-item list-group-item-action">初賽隊伍企劃書檔案下載列表</a>
                ...
                <!-- <a href="{{route('admin.team.qualifiers.download')}}" class="list-group-item list-group-item-action">進入複賽隊伍檔案(全部)</a> -->
                <a href="{{route('admin.team.qualifiers.form.download')}}" class="list-group-item list-group-item-action">進入複賽隊伍檔案(報名資料)</a>
