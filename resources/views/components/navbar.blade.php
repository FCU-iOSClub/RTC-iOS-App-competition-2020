        ...
        <li class="menu-has-children">
            ...
            <ul>
                ...
                <li class="menu-has-children">
                    ...
                    <ul>
                        <li>
                            <a href="/doc/2020年APP移動應用創新賽v1.1.pdf" onclick="event.preventDefault();window.open('/doc/2020年APP移動應用創新賽v1.1.pdf', '_blank');">章程</a>
                        </li>
                        <li>
                            <a href="/doc/2020年APP移動應用創新賽附件1~3.pdf" onclick="event.preventDefault();window.open('/doc/2020年APP移動應用創新賽附件1~3.pdf', '_blank');">附件</a>
                        </li>
                    </ul>
                </li>
            </ul>
