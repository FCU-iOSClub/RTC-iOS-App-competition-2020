  ...
  <div class="container-fulid text-center px-xl-5">
    <div class="no-gutters row stats-row justify-content-around justify-content-xl-around">
      <div class="stats-col text-center col-8 col-sm-5 col-md-3 col-xl-2">
        <div class="ratio-1-1">
          <div class="circle">
            <span class="stats-no" style="background-color: hsl(314, 66%, 59%)"><a>{{Carbon::parse(Setting::get('register_deadline', '2020-5-25'), 'Asia/Taipei')->month}}/{{Carbon::parse(Setting::get('register_deadline', '2019-5-15'), 'Asia/Taipei')->day}}</a></span>
        ...
        <div class="ratio-1-1">
          <div class="circle">
            ...
            <div class="circle-overflow" data-toggle="modal-hide" data-target="#date5-23">
              ...
              <div class="circle-overlay">
                <a><br>請在6⽉15⽇前以A4版面書寫5至10頁，另作封面註明隊伍名稱與作品名稱，檔案格式存成 PDF 檔，檔案名稱須同【聯絡人學校_聯絡人系級_聯絡人姓名_APP名稱_企劃書】</a>
                <a href="/doc/2020年APP移動應用創新賽附件1~3.pdf" style=" top:90%;color:aqua;" onclick="event.preventDefault();window.open('/doc/2020年APP移動應用創新賽附件1~3.pdf', '_blank');">附件</a>
        ...
        <div class="ratio-1-1">
          <div class="circle">
            ...
            <div class="circle-overflow" data-toggle="modal-hide" data-target="#date7-04">
              ...
              <div class="circle-overlay">
                <a>提交決賽現場的提案&nbsp &nbsp &nbsp<br>簡報檔、SOURCE CODE、&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<br>APP宣傳資料(附件三)，以及APP宣傳影片檔180秒,MP4格式,需上傳Youtube並把網站填入簡報中，請存成一個資料夾,並壓縮成.zip檔，檔案名稱須同【聯絡人學校_聯絡人系級_聯絡人姓名_參賽APP名稱_APP作品】。</a>
                <a href="/doc/2020年APP移動應用創新賽附件3.pdf" style=" top:90%;color:aqua;" onclick="event.preventDefault();window.open('/doc/2020年APP移動應用創新賽附件3.pdf', '_blank');">附件</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="stats-col text-center col-8 col-sm-5 col-md-3 col-xl-2">
        <div class="ratio-1-1">
          <div class="circle">
            <span class="stats-no" style="background-color: hsl(314, 66%, 59%)"><a>8/11</a></span>
            <div class="circle-overflow" data-toggle="modal-hide" data-target="#date8-02">
              <div class="circle-content">
                <a>決賽現場</a>
              </div>
              <div class="circle-overlay">
                <a>8月上旬於逢甲大學進行決賽，現場展演、答辯及評選，現場必須使用Apple硬體為載具進行展演，設備需自行攜帶。</a>
              </div>
            </div>
          </div>
        </div>
